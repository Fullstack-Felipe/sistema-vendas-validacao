...
// Estrutura que calcula o preço do ingresso com base no tipo
...
// FUNÇÃO: Gravar dados das vendas em ingressos.csv
...
//FUNÇÃO: Adicionar cabeçalho EMISSÃO DE INGRESSOS
...
void realizarConsulta() {
    ...
    char filtro[100]; // Define o filtro desejado
...
#define MAX_INGRESSOS 100 // Define o número máximo de ingressos que você deseja armazenar

struct Ingresso ingressos[MAX_INGRESSOS];
int numIngressosConsultados = 0; // Inicializa o contador de ingressos consultados


//FUNÇÃO: Adicionar cabeçalho CONSULTA DE INGRESSOS
   ...
   int searchTicketNumber; // Número de ingresso a ser pesquisado
    ...
    int found = 0;
        ...
        while (fgets(line, MAX_LINE_LENGTH, file) != NULL) {
            ...
            // Pula o primeiro token (primeira coluna = DataHotaEmissao)
            token = strtok(NULL, ";");
            ...
            if (token != NULL) {
                ...
                // Se o número de ingresso na linha atual for igual ao digitado, faz a validação
    ...
    // Fechar o arquivo ingressos.csv
    fclose(file);
    ...
    printf("\n\n---------------------------------------------\n\n");
    printf(" 1. Voltar para a validação de ingressos\n");
